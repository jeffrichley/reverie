...
**How the engine is meant to work, and where each decision came from.**

*Reverie* — the state of being pleasantly lost in an imagined place.

> ⚠️ **This describes a design, not an implementation.** No engine exists yet. The design is
> grounded in a literature review rather than invented from taste, and the parts that are
> unproven say so. Where the evidence is thin, this document says thin.

> **Read [the README](../README.md) first** if you want the short version of what Reverie is.
